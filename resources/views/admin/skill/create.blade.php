            ...
            <form method="POST" action="{{ route('admin.skill.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row my-4">
                    <div class="col-md-12">
                        ...
                        <input id="name" type="textarea" class="form-control @error('name') is-invalid @enderror"
                            name="name" placeholder="Titre de l'article" value="{{ old('name') }}" autofocus>
                        @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <textarea id="skills" type="textarea"
                                class="form-control @error('content') is-invalid @enderror" name="skills" autofocus>
                            </textarea>
                            @error('content')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
